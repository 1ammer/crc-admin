...
//        $users = User::all() ;
        ...
        return view('quiz.admin.user.indext', compact('users'));
    }
...
//        $users = User::all() ;
        ...
        return view('quiz.admin.user.indexs', compact('users'));
    }
    /**
...
try{
        ...
        $user->RGNumber = 'crcts'.rand(1000,100000);
        ...
        session()->flash('success', 'User Created Successfully');
                ...
                session()->flash('error', 'RGnumber already exist .');
