<ul class="sidebar navbar-nav toggled">
    ...
    <li class="nav-item dropdown"  >
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="{{route('user.all')}}"><i class="fa fa-users"></i> All Admins</a>
            <a class="dropdown-item" href="{{route('users.all')}}"><i class="fa fa-users"></i> All Students</a>
            <a class="dropdown-item" href="{{route('usert.all')}}"><i class="fa fa-users"></i> All Teachers</a>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="{{route('course.create')}}"><i class="fa fa-plus"></i> ADD Courses</a>
                    <a class="dropdown-item" href="{{route('degree.create')}}"><i class="fa fa-plus">
