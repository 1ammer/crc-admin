                    ...
                    <table class="table table-hover table-striped  " id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="  success  ">
                                ...
                                <td>{{$lecture->name}}</td>
                                <td> {{$lecture->title}}</td>
                                <td><a href="{{asset($lecture->pathfile)}}" rel="noopener noreferrer" download  class="btn btn-light"><i
                                            class="fa fa-download  "></i></a>
                                    <a href="{{asset($lecture->pathfile)}}" rel="noopener noreferrer"  class="btn btn-primary"><i
