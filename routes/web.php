...
Route::post('/coments', 'HomeController@comments')->name('comments.create');

Route::get('/courses/{id}', 'CourseController@courses')->name('user.courses');
...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/users/all', 'UserController@indexs')->name('users.all');
        Route::get('/usert/all', 'UserController@indext')->name('usert.all');
...
Route::group(['middleware' => 'teacher'], function () {
    ...
    Route::prefix('teacher')->group(function () {
        ...
        Route::get('/quiz/all', 'QuizController@index')->name('quiz.all');
                Route::get('/quiz/bank/{id}', 'QuizController@bank')->name('quiz.bank');
                Route::post('/quiz/qbank/{id}', 'QuizController@addQbank')->name('quiz.qbank');
        ...
        Route::get('/report/all', 'QuizController@treport')->name('report.all');
    });
});
...
Route::group(['middleware' => 'student'], function () {
    ...
    Route::prefix('student')->group(function () {
        ...
        Route::get('/request', 'UserController@emailrequest')->name('srequest');
        Route::post('/request', 'UserController@sendrequest')->name('srequest');
                Route::get('/report/all', 'QuizController@sreport')->name('sreport.all');
